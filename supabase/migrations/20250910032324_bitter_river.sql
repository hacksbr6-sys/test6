...
('João Silva', 'joao@teste.com', '(11) 99999-9999', 'senha123', FALSE),
('Maria Santos', 'maria@teste.com', '(11) 88888-8888', 'senha456', TRUE)
ON CONFLICT (email) DO NOTHING;

INSERT INTO clients (full_name, email, phone, password) VALUES
('Pedro Cliente', 'pedro@cliente.com', '(11) 77777-7777', 'senha789'),
('Ana Cliente', 'ana@cliente.com', '(11) 66666-6666', 'senha012')
ON CONFLICT (email) DO NOTHING;