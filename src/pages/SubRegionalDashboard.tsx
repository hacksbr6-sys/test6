...
const SubRegionalDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'cars' | 'invoices' | 'notifications'>('overview');
  ...
  // Verificar se o usuário é sub regional
  useEffect(() => {
    if (!currentUser || currentUser.type !== 'mechanic' || currentUser.position !== 'sub_regional') {
      navigate('/');
    }
  ...
  const handleAddCar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'general',
          message: `Novo veículo adicionado pelo Sub Regional: ${carForm.brand} ${carForm.model} (${carForm.year}) - $${carForm.price.toLocaleString()}`,
          is_read: false
        });
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Header */}
      <div className="bg-black/90 backdrop-blur-sm border-b-2 border-orange-600">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-white font-bold text-lg">PAINEL SUB REGIONAL</h1>
                  <p className="text-orange-400 text-sm">Acesso Total (Exceto Gestão de Mecânicos)</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-right">
              ...
              <p className="text-orange-400 text-sm">Sub Regional</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {activeTab === 'overview' && (
          ...
          >
            ...
            <div className="bg-orange-600/10 border border-orange-600 rounded-xl p-6">
              <h3 className="text-xl font-bold text-orange-400 mb-4">Permissões do Cargo Sub Regional</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <p className="text-white font-medium">✅ Fazer Vendas de Veículos</p>
                  <p className="text-white font-medium">✅ Gerar Notas Fiscais</p>
                  <p className="text-white font-medium">✅ Ver Todas as Notas Fiscais</p>
                  <p className="text-red-400 font-medium">❌ Gerenciar Mecânicos (Apenas Regional)</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cars.map((car) => (
                <div
                  key={car.id}
                  className="bg-black/50 rounded-xl border border-gray-800 hover:border-orange-600 transition-all duration-300 overflow-hidden"
                >
          ...
          >
            ...
            <div className="space-y-4">
              {invoices.map((invoice) => (
                <div
                  key={invoice.id}
                  className="bg-black/50 rounded-xl p-6 border border-gray-800 hover:border-orange-600 transition-all duration-300"
                >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <AlertCircle className={`h-4 w-4 ${
                            notification.is_read ? 'text-gray-400' : 'text-orange-400'
                          }`} />
      ...
      {showAddCarModal && (
        <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4">
          <motion.div
            ...
            className="bg-gray-900 rounded-xl p-6 max-w-md w-full border border-orange-600"
          >
            ...
            <form onSubmit={handleAddCar} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-orange-600 focus:outline-none"
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <button
                  ...
                  className="flex-1 bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-lg font-bold transition-colors disabled:opacity-50 flex items-center justify-center"
                >
                  {isSubmitting ? (
...
export default SubRegionalDashboard;